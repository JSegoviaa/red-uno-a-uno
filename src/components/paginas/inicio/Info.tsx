        ...
        <section className={styles.section1}>
          <Row>
            <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
              ...
              <div className={`${styles.content} mb-4`}>
                Red 1 a 1 permite la comunicación y el intercambio de carteras
                de clientes y propiedades. A través de esta herramienta versátil
                ...
                nuestra comunidad de asesores y obtén más resultados en ventas
                con la mejor estrategia para los asesores inmobiliarios.
              </div>
