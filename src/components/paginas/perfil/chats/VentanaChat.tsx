                    ...
                    <div className="col-12">
                        <div className={styles.header}>
                            <div className="row">
                                ...
                                <div className="col-2 text-end">
                                    <button type="button" className="btn-close btn-close-white mt-3" aria-label="Close"></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-12">
                        <div className={styles.chatBox}>
                            <div className="row d-flex justify-content-center">
                                ...
                                <div className="col-11 mb-2">
                                    <div className={styles.mensaje1}>
                                        Voy a vender la casa de isla, pero no se que precio ponerle, puedes pasarme tu 
                                        contacto del valuador? para empezar con los tramites, ya sabes tambien te va a 
                            ...
                            <div className="row d-flex justify-content-center">
                                <div className="col-12">
                                    <div className="input-group">
                                        <input type="text" className={`${styles.messageBox} form-control`} placeholder="Mensaje..." aria-label="Recipient's username" aria-describedby="basic-addon2" />
                                        <span className={`${styles.btnEnviar} input-group-text`} id="basic-addon2">
                                            <button className={styles.iconSend}><i className="bi bi-send text-white"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
